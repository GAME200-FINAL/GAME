...
Shader "Shader Forge/normaltest" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_922; uniform float4 _node_922_ST;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _node_922_var = tex2D(_node_922,TRANSFORM_TEX(i.uv0, _node_922));
                float3 normalLocal = _node_922_var.rgb;
